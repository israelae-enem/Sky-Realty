      ...
      case 'addProperty':
        return (
          <motion.div key={activeTab} className="space-y-4" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} transition={{ duration: 0.25 }}>
            <PropertyForm companyId={user?.id} onSuccess={fetchAllData}  />
...
case 'contactedLeads':
  return (
    ...
    >
      ...
      case 'team':
        return (
          <motion.div key="team" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} transition={{ duration: 0.25 }}>
      ...
      case 'manageAccount':
        return (
          <motion.div key="manageAccount" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} transition={{ duration: 0.25 }}>
            <ManageAccountForm />
          </motion.div>
        )
